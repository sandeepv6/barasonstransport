          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-sm">
                ...
                <div> barasonstransport@hotmail.com</div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#why-choose" className="hover:text-blue-200">
                Why Choose Us
              </a>
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4 space-y-2">
              ...
              <a href="#why-choose" className="block hover:text-blue-200">
                Why Choose Us
              </a>
              <a href="#services" className="block hover:text-blue-200">
                Services
              </a>
              <a href="#jobs" className="block hover:text-blue-200">
                Jobs
              </a>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8">
            North America's leading transport and logistics company
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl font-bold text-blue-900 mb-8">
              Just Like You, We Strive to Be the Best in the Industry
            </h3>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                For over two decades, Bara & Sons Logistics has been a leader in
                providing transportation and logistics services. We work with
                passionate, efficient drivers to deliver top-level professional
                services and reliability to our customers 24/7.
              </p>
              <p className="text-lg text-gray-700 mb-8">
                Bara & Sons Logistics is North America's leading transport and
                logistics company that goes the extra mile to help clients keep
                promises. We focus on providing superior transportation services
                while putting our customers and drivers first.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Why Choose Bara & Sons Logistics
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-lg">
                At Bara & Sons Logistics, we know how hard you work to rise
                above your competition. We work hard to exceed your
                expectations, no matter your transportation needs.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl mb-4"></div>
              ...
              <p className="text-lg">
                When you hire Bara & Sons Logistics, we work hard to deliver the
                results you want at affordable prices. Our team will find
                top-level, cost-effective transportation solutions.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl mb-4"></div>
              ...
              <p className="text-lg">
                We tailor our operations to empower our drivers and elevate our
                customers to achieve more. Your success is our priority.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Comprehensive transportation solutions for all your logistics
              needs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-700">
                Bara & Sons Logistics is one of North America's leading trucking
                companies serving clients throughout the US and Canada. We
                provide on-time deliveries with personalized programs, unmatched
                safety practices, and satellite tracking.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-700">
                No matter the size of your business or industry, contact Bara &
                Sons Logistics for all your LTL freight shipping. We offer
                dependable transportation to safely transport your products even
                when you can't fill a truck.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-700">
                Whenever you want to move your freight, during the day or at
                night, trust Bara & Sons Logistics to be there. We focus on
                providing top-level services and speed using cutting-edge
                technology.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-700">
                Specialized temperature-controlled transportation for sensitive
                goods. Our refrigerated trucks maintain precise temperature
                control throughout your shipment's journey.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-700">
                Whether you need long distance hauling to any location in Canada
                or across the US states, contact Bara & Sons Logistics. We offer
                a wide range of long distance transportation services.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-700">
                Are you searching for affordable transportation for high-volume,
                heavy products? We provide convenient and affordable dry van
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                At Bara & Sons Logistics, we believe in investing in our team.
                We provide competitive remuneration and flexible benefit
                packages so we can hire and retain the best employees in the
                trucking industry.
              </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-lg">
                      barasonstransport@hotmail.com
                    </span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-2xl mr-4"></span>
                    <span className="text-lg">
                      123 Logistics Way, Toronto, ON M1M 1M1
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      We strive for excellence in every delivery and service we
                      provide.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      We listen to your needs and tailor our services
                      accordingly.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                North America's leading transport and logistics company
                providing reliable, cost-effective transportation solutions.
              </p>
            </div>
            <div>
